            ...
            <div className="card-body">
                <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                        ...
                        {props.input.bool ? <div className="h5 mb-0 font-weight-bold text-gray-800">{props.input.value}
                        </div> : <div className="row no-gutters align-items-center">
                            <div className="col-auto">
                                <div className="h5 mb-0 mr-3 font-weight-bold text-gray-800" style={{marginLeft:"12px"}} >{props.input.value}%</div>
                            </div>
                            <div className="col">
                    ...
                    <div className="col-auto">
                        <i className={`fas ${props.input.symbol} fa-2x text-gray-300`}></i>
                    </div>
                </div>
            </div>
        </div>
